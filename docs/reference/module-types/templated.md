...
# other modules or runtime variables. See the [Environment configuration
# context](https://docs.garden.io/reference/template-strings#environment-configuration-context) to see template
